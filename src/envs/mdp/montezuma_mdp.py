import copy
import random
from envs.mdp.montezuma_state import MontezumeState
...
class MontezumaMDP:
    def __init__(self, env, render):
        ...
        self.actions = range(self.env.wrapped_env.mont_env.action_space.n)

        self.reset()

    def get_current_ale(self):
        return self.env.wrapped_env.mont_env.ale
